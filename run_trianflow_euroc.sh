# EUROC_tracks='MH_02_easy MH_03_medium MH_04_difficult MH_05_difficult V1_01_easy V1_02_medium V1_03_difficult V2_01_easy V2_02_medium V2_03_difficult'
EUROC_tracks='MH_04_difficult'
...
do
    ...
    python infer_vo.py  --config_file ./config/euroc.yaml \
                        ...
                        --sequences_root_dir /home/olaya/Datasets \
                        --sequence $track \
